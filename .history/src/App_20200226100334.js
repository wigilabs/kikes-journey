              ...
              <div class="box">
                <section>
                  <div class="row">
                    ...
                    <div class="column green">
                      <span>{this.state.c2rw1 - 10}</span>
                      <p>Huevo 2</p>
                    </div>
                    <div class="column">
                      <span>{this.state.c3rw1 - 10}</span>
                      <p>Huevo 3</p>
                    </div>
                  </div>
                  <div class="row">
                    <div class="column">
                      <span>{this.state.c1rw2 - 10}</span>
                      <p>Huevo 1</p>
                    </div>
                    <div class="column">
                      <span>{this.state.c2rw2 - 10}</span>
                      <p>Huevo 2</p>
                    </div>
                    <div class="column"></div>
                  </div>
              ...
              <div class="box">
                <section>
                  <div class="row">
                    ...
                    <div class="column">
                      <span>{this.state.c3rw1 - 20}</span>
                      <p>Huevo 3</p>
                    </div>
                  </div>
                  <div class="row">
                    <div class="column">
                      <span>{this.state.c1rw2 - 20}xx</span>
                      <p>Huevo 1</p>
                    </div>
                    <div class="column">
