...
class App extends React.Component {
  ...
  render() {
    /**
     * Se define un intervalo iterable considerando minimos y maximos
     *  setInterval(() => {
      if (n.min || n.min == 0)
    ...
    this.setState({
      ...
      //c1rw3: parseInt(this.state.c1rw3) + 2,
      //c1rw4: parseInt(this.state.c1rw4) + 3
    });
    */
    this.state.c1rw1 = parseInt(this.state.c1rw1) + 1;
    console.log(this.state.c1rw1);
    /*
    setInterval(() => {
      this.setState({
        c1rw1: parseInt(this.state.c1rw1) + 1
