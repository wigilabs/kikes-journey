...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    this.Clock("c1rw1", "c2rw1", "c3rw1", "c1rw2");
            ...
            <div class="column">
              ...
              <div class="box">
                <section>
                  <div class="row">
                    <div class="column">
                      <span>{this.state.c1rw1 - 23}</span>
                      <p>Huevo 1</p>
                    </div>
                    <div class="column green">
                      <span>{this.state.c2rw1 - 22}</span>
                      <p>Huevo 2</p>
                    </div>
                    <div class="column">
                      <span>{this.state.c3rw1 - 25}</span>
                      <p>Huevo 3</p>
                    </div>
                  </div>
                  <div class="row">
                    <div class="column">
                      <span>{this.state.c2rw1 - 23}</span>
                      <p>Huevo 1</p>
                    </div>
                    <div class="column">
