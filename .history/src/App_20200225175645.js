...
class App extends React.Component {
  ...
  render() {
    ...
    setInterval(() => {
      this.setState({
        c1rw22: parseInt(this.state.c1rw1) + 1
      });
    }, parseInt(this.prodTime) * 2);
    setInterval(() => {
      this.setState({
        c1rw33: parseInt(this.state.c1rw1) + 1
      });
    }, parseInt(this.prodTime) * 4);
    setInterval(() => {
      this.setState({
        c1rw44: parseInt(this.state.c1rw1) + 1
      });
    }, parseInt(this.prodTime) * 8);
    //end col1 - 2
    // col2 - 1
    ...
    setInterval(() => {
      this.setState({
        c2rw2: parseInt(this.state.c2rw1) + 1
      });
    }, parseInt(this.prodTime) * 2);
    setInterval(() => {
      this.setState({
        c2rw3: parseInt(this.state.c2rw1) + 1
      });
    }, parseInt(this.prodTime) * 4);
    setInterval(() => {
      this.setState({
        c2rw4: parseInt(this.state.c2rw1) + 1
      });
    }, parseInt(this.prodTime) * 8);
    //end col2 - 1
    // col2 - 2
    ...
    setInterval(() => {
      this.setState({
        c2rw22: parseInt(this.state.c2rw1) + 1
      });
    }, parseInt(this.prodTime) * 2);
    setInterval(() => {
      this.setState({
        c2rw33: parseInt(this.state.c2rw1) + 1
      });
    }, parseInt(this.prodTime) * 4);
    setInterval(() => {
      this.setState({
        c2rw44: parseInt(this.state.c2rw1) + 1
      });
    }, parseInt(this.prodTime) * 8);
    //end col2 - 2
    //col3
    ...
    setInterval(() => {
      this.setState({
        c3rw2: parseInt(this.state.c3rw1) + 1
      });
    }, parseInt(this.prodTime) * 2);
    setInterval(() => {
      this.setState({
        c3rw3: parseInt(this.state.c3rw1) + 1
      });
    }, parseInt(this.prodTime) * 4);
    setInterval(() => {
      this.setState({
        c3rw4: parseInt(this.state.c3rw1) + 1
      });
    }, parseInt(this.prodTime) * 8);
    //end col3
    //Return view
